...
const title = "Tradiemate AI | Your AI Email Assistant";
const description =
  "Tradiemate AI is your AI personal assistant for email management. Automate your email, bulk unsubscribe from newsletters, block cold emails, and streamline your communication workflow.";
