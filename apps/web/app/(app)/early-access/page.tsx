      ...
      <div className="mx-auto max-w-2xl space-y-4 sm:space-y-8">
        ...
        {/* <Card className="mx-auto mt-2 w-full max-w-2xl sm:mt-8">
          ...
          <div className="mt-2 max-w-prose">
            <SectionDescription>
              Use the Tradiemate AI email client to manage your email.
            </SectionDescription>
          </div>
          <div className="mt-4">
        ...
        {/* <Card className="mx-auto mt-2 w-full max-w-2xl sm:mt-8">
          <PageHeading>Tradiemate AI Daily Challenge</PageHeading>
          <div className="mt-2 max-w-prose">
            <SectionDescription>
              Getting to tradiemate ai is overwhelming. But doing it for a single day
              is doable.
            </SectionDescription>
            <SectionDescription>
